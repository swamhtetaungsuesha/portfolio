...
const ProjectCard = ({ data, index }: { data: any; index: number }) => {
  return (
    <div className="border-b border-white/10 px-10 h-44 flex flex-row items-center w-full hover:bg-white/10 transition-all duration-700 group overflow-hidden">
      <div className="flex flex-row items-center gap-10 justify-between w-full h-full">
        ...
        <div className="flex items-center gap-5 relative h-full">
          ...
          <p className="w-96 group-hover:opacity-0">{data.description}</p>
